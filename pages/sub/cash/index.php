...
<head>
	...
	<title>Painel - Cash</title>
	<link rel="stylesheet" type="text/css" href="../../css/style.css">
	<link rel="stylesheet" type="text/css" href="../../css/content.css">
	<link rel="stylesheet" type="text/css" href="../../css/header.css">
	<link rel="stylesheet" type="text/css" href="../../css/navbar.css">
	<link rel="stylesheet" type="text/css" href="../../css/tables.css">
	<link rel="stylesheet" type="text/css" href="../../css/table-cash.css">
		...
		if ($groupid >= 2){
			...
			<nav id='navbar'>
				<ul>
					...
					<li class='item selected'><a href=''><i class='fa fa-shopping-basket' aria-hidden='true'></i>Cash</a></li>
				...
				echo "<div id='page'>";
			require_once("../../other-pages/tabela-cash.php"); 
				echo "</div>";
