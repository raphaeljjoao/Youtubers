...
<head>
	...
	<title>Painel - Youtubers</title>
	<link rel="stylesheet" type="text/css" href="../../css/style.css">
	<link rel="stylesheet" type="text/css" href="../../css/content.css">
	<link rel="stylesheet" type="text/css" href="../../css/header.css">
	<link rel="stylesheet" type="text/css" href="../../css/navbar.css">
	<link rel="stylesheet" type="text/css" href="../../css/tables.css">
	<link rel="stylesheet" type="text/css" href="../../css/table-youtubers.css">
		...
		if ($groupid >= 2){
			...
			<nav id='navbar'>
				<ul>
					...
					<li class='item selected'><a href=''><i class='fa fa-users' aria-hidden='true'></i>Youtubers</a></li>
					<li class='item'><a href='../cash'><i class='fa fa-shopping-basket' aria-hidden='true'></i>Cash</a></li>
					<li class='item'><a href='../staff'><i class='fa fa-list' aria-hidden='true'></i>Equipe</a></li>
					<!-- <li class='item'><a href=''><i class='fa fa-user-plus' aria-hidden='true'></i>Grupos</a></li> -->
				</ul>
			</nav>";
				echo "<div id='page'>";
			require_once("../../other-pages/tabela-youtubers.php"); 
				echo "</div>";
